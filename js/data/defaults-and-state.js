...
const updateLog = [
    ...
    },
    {
        ...
        notes: [
            ...
            "- 支持配置、连接及使用外部 MCP 服务。",
            "- 优化 MCP 与当前聊天功能的兼容。",
            "2. 去除原登录系统，打开后可以直接进入使用。",
            "3. 优化自动总结：",
            "- 修复部分自动总结无法正常执行的问题。",
            "- 新增总结可视化，可以更加直观地查看总结内容及处理情况。",
            "4. 优化大量数据情况下的运行表现，减少聊天记录、记忆等数据较多时出现明显卡顿的问题。",
            "5. 全面优化生图及语音相关接口：",
            "- 修复 NovelAI 生图自定义地址无法正常使用的问题。",
            "- 修复 GPT 生图相关问题。",
            "- 新增 Gemini 生图。",
            "- 新增火山引擎语音。",
            "- 修复 NM 语音相关问题。",
            ...
            "- 优化当前语音通话。",
            "- 优化视频通话。",
            "- 修复通话过程中出现空回复时无法正确报错或继续处理的问题。",
            "- 优化通话回复的稳定性。",
            "8. 优化当前 API 与思维链兼容：",
            "- 改进不同 API 返回格式的处理。",
            "- 优化流式与非流式回复。",
            "- 减少思维链内容影响正常回复解析的问题。",
            "9. 优化头像识别系统，提高头像识别、绑定及相关数据处理的稳定性。",
            "10. 优化论坛：",
            "- 调整部分论坛功能逻辑。",
            "- 优化帖子、账号、私信及 AI 互动相关处理。",
            "- 修复部分论坛场景下的异常。",
            "11. 优化 iOS 27 系统下的模糊及显示问题，同时进一步处理 iOS 安全区适配。",
            "12. 优化后台保活：",
            "- 修复部分切换后台后任务容易中断的问题。",
            "- 新增内置静音音频保活方式。",
            "- 优化页面恢复后的状态处理。",
            "13. 尝试修复部分接口出现的 400 请求错误，尤其针对部分特殊 API / 克隆接口的兼容情况进行了调整。",
            "14. 优化自定义提示词：",
            "- 新增更加清晰的提示词管理方式。",
            "- 优化提示词分层。",
            "- 分层设计灵感来源于 **1900老师**，感谢分享与授权。",
            "15. 优化并修复亲属卡相关功能。",
            "16. 优化后台消息：",
            "- 改进应用处于后台时的消息处理。",
            "- 优化恢复页面后的消息状态及回复衔接。",
            ...
            "- 新增最新轮次保护。",
            "- API 设置中增加对应开关。",
            "- 如果仍然遇到回复对应错误轮次的问题，可以尝试开启该功能。",
            "18. 新增「追加回复」：",
            "- 可以在当前回复基础上继续让角色补充内容。",
            "- 不需要重新发送一条新的用户消息。",
            "19. 新增「拍一拍」互动功能。",
            "20. 优化聊天回复稳定性，增加部分异常回复恢复及保护逻辑，减少 API 返回异常时直接影响当前聊天的问题。",
            "21. 优化自定义提示词相关功能及提示词工作室逻辑，让不同用途的提示词更加容易管理。",
            "22. 优化部分选择框及移动端操作体验，减少不同设备上的原生控件显示差异。",
            "————",
            "本次对聊天、API、生图、记忆和后台运行都进行了较多调整。如果更新后遇到特殊 API 无法使用、回复错轮或后台回复异常，可以附带使用的 API 类型和具体操作过程反馈。"
        ]
    },
    {
        version: "6.8.1",
